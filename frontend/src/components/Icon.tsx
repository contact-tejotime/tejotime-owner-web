...
/**
 * Curated TejoTime icon set (Lucide geometry): 24×24 viewBox, 2px stroke,
 * round caps/joins, currentColor. Ported 1:1 from the design system's
 * components/core/Icon.jsx. Add a glyph by adding its inner SVG markup here.
 */
export const ICONS: Record<string, string> = {
  ...
  qrCode: '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3M21 14v.01M14 21h.01M21 18v3M18 21h.01"/>',
...
/** Stroke icon from the TejoTime curated set (Lucide geometry). */
