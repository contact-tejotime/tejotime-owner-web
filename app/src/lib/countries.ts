// Auto-generated country list (ISO 3166-1 alpha-2, English name, calling code).
// Source: libphonenumber-js getCountries()/getCountryCallingCode() + Intl.DisplayNames.
// 245 countries, sorted by name. Flag emoji is derived at runtime from iso2.
...
export const COUNTRIES: Country[] = [
  ...
  { iso2: "AG", name: "Antigua & Barbuda", dialCode: "1" },
  ...
  { iso2: "CD", name: "Congo - Kinshasa", dialCode: "243" },
  ...
  { iso2: "PS", name: "Palestinian Territories", dialCode: "970" },
  ...
  { iso2: "ST", name: "São Tomé & Príncipe", dialCode: "239" },
  ...
  { iso2: "BL", name: "St. Barthélemy", dialCode: "590" },
  { iso2: "SH", name: "St. Helena", dialCode: "290" },
  { iso2: "KN", name: "St. Kitts & Nevis", dialCode: "1" },
  { iso2: "LC", name: "St. Lucia", dialCode: "1" },
  { iso2: "MF", name: "St. Martin", dialCode: "590" },
  { iso2: "PM", name: "St. Pierre & Miquelon", dialCode: "508" },
  { iso2: "VC", name: "St. Vincent & Grenadines", dialCode: "1" },
  { iso2: "SD", name: "Sudan", dialCode: "249" },
  { iso2: "SR", name: "Suriname", dialCode: "597" },
  { iso2: "SJ", name: "Svalbard & Jan Mayen", dialCode: "47" },
  ...
  { iso2: "TT", name: "Trinidad & Tobago", dialCode: "1" },
  ...
  { iso2: "TC", name: "Turks & Caicos Islands", dialCode: "1" },
  ...
  { iso2: "WF", name: "Wallis & Futuna", dialCode: "681" },
