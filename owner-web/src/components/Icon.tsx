...
export const ICONS: Record<string, string> = {
  ...
  /** Settings' Dark mode row — the app's glyph (Lucide moon). It used the `settings` gear here. */
  ...
  /**
   * The app's `sparkles` (Lucide's four-point star) — Settings' Appearance row. A separate key
   * because the web's `sparkles` above is a radial burst that WalkInSheet already draws.
   */
  sparklesStar:
  ...
  /** Services list row's trailing pencil — the app's `edit` glyph. */
  edit:
    '<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4z"/>',
  /** A read-only field's trailing mark, as the app's TInput draws on a disabled input. */
